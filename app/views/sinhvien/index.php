...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <thead>
    ...
    <tbody>
        ...
        <tr style="background-color: #f9f9f9;">
            ...
            <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                <?php if ($sv->Hinh): ?>
                    <img src="/student/public/assets/images/<?= basename($sv->Hinh) ?>" width="50" alt="Ảnh sinh viên" style="border-radius: 5px;">
                <?php else: ?>
                    Không có ảnh
                <?php endif; ?>
            </td>
